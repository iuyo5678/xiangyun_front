...
<div class="container">
    ...
    <div id="content" class="<?php echo $class; ?>">
        ...
        <div class="statistics-container">
            <h3>黄页PV UV 点击汇总统计</h3>
            <p class="description ">目前所有黄页卡片在搜索结果下的Pv Uv 点击量数据,卡片名称包块维修simple, weixiu_weak, banjiasimple, banjiaexact banjiaweak, baojiesimple, baojieweak, wz_hy_multi</p>
            <div id="content-top">
...
<script>
    $(document).ready(function () {
        all_cards = ['wz_weixiusimple', 'wz_weixiuweak', 'wz_banjiasimple', 'wz_banjiaweak','wz_baojiesimple', 'wz_baojieweak', 'wz_hy_multi'];
